...
const AdicionarTarefa: React.FC<AdicionarTarefaProps> = ({ onAdicionarTarefa }) => {
  ...
  return (
    <View style={{ backgroundColor: '#A7FC00', paddingVertical: 50, paddingHorizontal: 20, paddingTop: 50 }}>
      {/* Título da lista de tarefas */}
      <Text fontSize="3xl" color="#402291" mb={4}>Lista de Tarefas Jhoe Hashimoto</Text>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <View style={{ flex: 1, marginRight: 10 }}>
          ...
          <Input
            ...
            placeholderTextColor="#402291" // Cor do placeholder
